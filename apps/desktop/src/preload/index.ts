...
const api: VideorcApi = {
  ...
  setShortcutRecorderArmed: (armed) => invoke('shortcut-recorder:set-armed', armed),
  onShortcutRecorderKey: (callback) => subscribe('shortcut-recorder:key', callback),
  onShortcutRecorderDisarmed: (callback) => subscribe('shortcut-recorder:disarmed', callback),
  ...
  pushDashboard: (state) => invoke('comments-window:dashboard-push', state),
