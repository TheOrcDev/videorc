...
const idleDiagnosticStats = (): DiagnosticStats => ({
  ...
  encoderBridgeEncodedOutputBackend: undefined,
  encoderBridgeRequestedVideoOutput: undefined,
  encoderBridgeEffectiveVideoOutput: undefined,
  encoderBridgeEncodedOutputEncoderIdentity: undefined,
  encoderBridgeEncodedOutputInputSubtype: undefined,
  encoderBridgeEncodedOutputFallbackReason: undefined,
  encoderBridgeEncodedOutputFrames: 0,
  encoderBridgeEncodedOutputBytes: 0,
  encoderBridgeEncodedOutputErrors: 0,
  encoderBridgeEncodedSubmitP95Ms: undefined,
  encoderBridgeEncodedFifoWriteP95Ms: undefined,
  encoderBridgeActiveEncodedOutputEncoders: 0,
  encoderBridgeRecordingEncodedOutputFrames: 0,
  encoderBridgeRecordingEncodedOutputBytes: 0,
