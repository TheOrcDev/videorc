...
| 040  | Replace the Windows display media path with D3D11 shared textures                                                                                                                                                                                                                                                   | P1       | L      | 039 Steps 1-5                                                                                                                                                                | IN PROGRESS (2026-08-02; Step 0 reconciled against `d85f9b4c` and direct-recording predecessor `de4c1f88`; recovered source implementation and portable contract gates are active; final Windows source lane, signed installed candidate, GPU/presenter/performance matrix, and natural-fallback host evidence remain BLOCKED) |
